defmodule BloodPressureWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(BloodPressureWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(BloodPressureWeb.Gettext, "errors", msg, opts)
    # end
